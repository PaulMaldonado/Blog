...
<section class="container-fluid content py-5">
    <div class="row justify-content-center">
        ...
        <div class="col-12 col-md-7 text-center">
            ...
            <hr>
            <img src="images/imagen3.jpg" alt="Post Javascript" class="img-fluid">
        ...
        <div class="col-md-3 offset-md-1">
            ...
            <div class="row mb-4">
                <div class="col-4 p-0">
                    <a href="#">
                        <img src="images/macbook.jpg" class="img-fluid rounded" width="100" alt="">
                    </a>
                </div>
            ...
            <div class="row mb-4">
                <div class="col-4 p-0">
                    <a href="#">
                        <img src="images/imagen2.jpg" class="img-fluid rounded" width="100" alt="">
                    </a>
                </div>
                <div class="col-7 pl-0">
